...
from tabular_data_framework.plot_distributions import numpy_to_dataframe
...
def round_counterfactuals(X,results,dataset,training,dico_round) :
    ...
    return {"X" : X,
            "cf" : counterfactuals_min_max_round,
            "X_original_space" : orginal_examples_round, # Examples
            "cf_original_space" : original_counterfactuals_round, # Counterfactuals
