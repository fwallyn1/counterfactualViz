...
class CVAE_join(Load_dataset_carla if set_carla() else Load_dataset_base) :
    def __init__(self, dataset_config_dict,model_config_dict,cat_arrays,cont_shape,ablation,condition,shared_layers=True,debug_enc=False):
